        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="banner_text_one">
              <h1 class="flipInX" style="animation-duration: 3.0s; animation-delay: .3s">Live For <span class="flipInX"
                                                                                                        style="animation-duration: 2.0s; animation-delay: .5s">Fashion</span>
              </h1>
              <h3>Save Up To 50%</h3>
          ...
          <div class="col-lg-6">
            <div class="hero_img">
              <img :src="require('@/assets/img/common/man.png')" alt="img" class="slideInRight"
                   style="animation-duration: 3.0s; animation-delay: .3s">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <b-tabs class="hot-product-area-tabs">
          <b-tab
              ...
              class="row"
          >
            <div class="col-lg-3 col-md-4 col-sm-6 col-12" v-for="(product,index) in getCategoryProduct(collection)"
                 :key="index">
          ...
          <div class="col-lg-8 offset-lg-4 col-md-7 offset-md-4 col-sm-12 col-12">
            <div class="offer_time_flex">
              ...
              <div class="offer_timer_text">
                ...
                <p>
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit. Porro quisquam, odit assumenda sit modi
                  commodi esse necessitatibus temporibus aperiam veritatis eveniet!
                </p>
